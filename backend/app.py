...
def render_profiles_page() -> None:
    ...
    # ─────────────────────────────────────────────────────────────────────────
    # Tab 4 — Generate Strategy (Pine Script)
    # ─────────────────────────────────────────────────────────────────────────
    ...
    with tab4:
        st.subheader("Pine Script Strategy Generator")
        st.caption(
            "Configure indicators, parameters, and entry logic, then generate a "
            "ready-to-paste TradingView Pine Script v6 strategy."
        )
